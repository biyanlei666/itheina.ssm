                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" onclick="window.location.href='${pageContext.request.contextPath}/pages/product-add.jsp'" title="新建"><i class="fa fa-file-o"></i> 新建</button>
